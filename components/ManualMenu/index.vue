<template>
  <nav v-show="manualMenuOpen || $breakpoints.lMd" id="side-navbar" class="fixed w-full md:w-[35rem] h-full min-h-screen bg-black z-10 top-[7.5rem]" :class="manualMenuClass">
