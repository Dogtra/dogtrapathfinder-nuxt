<template>
  <div class='manual-menu-container h-full text-18'>
    ...
    <div class="manual-menu-chapter-list bg-black text-white h-full px-12 py-8">
      <div class='bg-yellow text-black inline-block rounded-full px-4 py-1 flex items-center w-fit'>
