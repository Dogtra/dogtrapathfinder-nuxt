    ...
    <div class='bg-white'>
      <div class='px-12 max-w-[71rem]'>
        ...
        <div class='sticky pb-4 bottom-0 flex justify-between text-16 font-bold'>
          <NuxtLink :to='localePath(previousArticleUrl)' class='flex items-center rounded-[0.5rem] bg-black text-yellow hover:bg-yellow hover:text-black pr-4'><span class='mdi mdi-chevron-left text-22'></span>{{ $t('manuals.previous') }}</NuxtLink>
          <NuxtLink :to='localePath(nextArticleUrl)' class='flex items-center rounded-[0.5rem] bg-black text-yellow hover:bg-yellow hover:text-black pl-4'>{{ $t('manuals.next') }}<span class='mdi mdi-chevron-right text-22'></span></NuxtLink>
        </div>
      </div>
    </div>
    </div>
